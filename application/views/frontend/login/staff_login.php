					...
					<div class="topSigin">
							...
							<div class="form_content">
								...
								<form action="<?= base_url('staff/user_login/'.$type) ?>" class="" method="post" id="user_login_form" autocomplete="off">
									...
									<div class="login_form" >
										...
										<div class="form-group">
											<label><i class="fa fa-key"></i> <?= !empty(lang('password'))?lang('password'):"password";?> <a href="<?= base_url('customer/forgot/'.$type);?>" class="ml-7"><?= !empty(lang('forgot'))?lang('forgot'):"Forgot?";?></a></label>
						...
						<?php if(is_demo()==1): ?>
							<div class="btns" style="display: flex;
								...
								<a href="javascript:;" data-user="01745419091" data-pas="123" class="btn btn-info mr-1 loginBTN"><i class="icofont-fast-delivery"></i>  Delivery Guy</a>
