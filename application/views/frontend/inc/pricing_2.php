            ...
            <div class="princing-item red bg-white mt-0 shadow">
                <div class="priceTopCard">
                    <div class="pricing-divider ">
                        ...
                        <?php else: ?>
                            <h4 class="my-0  text-light font-weight-normal mb-3"> <?= admin_currency_position(html_escape($package['price'])) ;?> <span class="h5">/ <?= !empty(lang(strtolower(get_package_type($package['package_type']))))?lang(strtolower(get_package_type($package['package_type']))):get_package_type($package['package_type']);?></span></h4>
                        <?php endif;?>
