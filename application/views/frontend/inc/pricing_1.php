        ...
        <div class="card mb-5 mb-lg-0">
          <div class="card-body NewPricCard">
            <div class="priceTopCard">
                ...
                <?php else: ?>
                    <h6 class="card-price text-center"><?= admin_currency_position(html_escape($package['price'])) ;?><span class="period">/<?= !empty(lang(strtolower(get_package_type($package['package_type']))))?lang(strtolower(get_package_type($package['package_type']))):get_package_type($package['package_type']);?></span></h6>
                <?php endif;?>
                <hr>
