								...
								<tbody>
									...
									<?php foreach ($item_list as $key => $row): ?>
										<?php 
							             ...
							             $grand_total = grand_total($net_total,$order_info['delivery_charge'],$order_info['discount'],$order_info['tax_fee'],$order_info['coupon_percent'],$order_info['tips'],$order_info['order_type'],shop($shop_id)->tax_status);
