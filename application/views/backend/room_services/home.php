							...
							<?php foreach ($hotel_list as $key => $row): ?>
								<tr>
								    ...
								    <td>
								    	...
								    	<a href="<?= base_url('delete-item/'.html_escape($row['id']).'/menu_type'); ?>" class=" action_btn btn btn-danger btn-sm" data-msg="<?= !empty(lang('want_to_delete'))?lang('want_to_delete'):"want to delete";?>"><i class="fa fa-trash"></i> </a>
								    </td>
							    </tr>
							<?php endforeach ?>
