							...
							<tr>
								...
								<td>
									...
									<?php if(is_access('delete')==1): ?>
										<a href="<?= base_url('delete-item/'.html_escape($row['id']).'/admin_notification_list'); ?>" class="btn btn-danger btn-sm action_btn" data-msg="<?= !empty(lang('want_to_delete'))?lang('want_to_delete'):"Want to Delete?";?>"><i class="fa fa-trash"></i></a>
									<?php endif;?>
