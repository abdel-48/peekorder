		...
		<div class="card pricing_3">
			<div class="card-body">
				<div class="card_top">
					...
					<?php else: ?>
						<h6 class="card-price text-center"><?= get_currency('icon');?><?= admin_currency_position(html_escape($active_package['price'])) ;?><span class="period">/<?= !empty(lang(strtolower(get_package_type($active_package['package_type']))))?lang(strtolower(get_package_type($active_package['package_type']))):get_package_type($active_package['package_type']);?></span></h6>
					<?php endif;?>
				</div>
				<hr>
				<div class="list_ul">
			...
			<div class="card-body">
				<div class="priceTagLayout">
					<div class="card_top">
						...
						<?php else: ?>
							<h6 class="card-price text-center"><?= admin_currency_position(html_escape($row['price'])) ;?><span class="period">/<?= !empty(lang(strtolower(get_package_type($row['package_type']))))?lang(strtolower(get_package_type($row['package_type']))):get_package_type($row['package_type']);?></span></h6>
						<?php endif;?>
					</div>
					<hr>
					<div class="list_ul">
