<div class="row">
	...
	<div class="col-md-4">
		<form action="<?= base_url("admin/restaurant/add_menu_style"); ?>" method="post">
			<?= csrf(); ;?>
			<div class="card">
				<div class="card-header">
					<h3><?= lang('menu_style'); ?></h3>
				</div>
				<div class="card-body">
					<div class="row">
						<div class="">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<label class="pointer layoutImg menu_style">
											...
											<input type="radio" name="menu_style" value="<?= $i; ;?>" class="icheck" <?= isset($u_info['menu_style']) && $u_info['menu_style']==$i?'checked':'';?>>
										</label>
									</div>
								</div>
							<?php  }?>
