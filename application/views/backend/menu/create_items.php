			...
			<div class="box box-primary">
				<div class="box-header with-border dflex">
					...
					<?php if(!isset($_GET['action'])): ?>
						...
						<a href="#extraListModal" data-toggle="modal" class="addnewBtn btn btn-info btn-flat"><i class="icofont-library"></i> &nbsp;<?= !empty(lang('add_extras'))?lang('add_extras'):"Add Extras";?></a>	
					<?php endif;?>
