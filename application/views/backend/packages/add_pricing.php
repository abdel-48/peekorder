						...
						<div class="col-md-6">
						    ...
						    <div class="form-group col-md-12">
						        ...
						        <select name="package_type" class="form-control account_duration" id="" required="">
						        	...
						        	<option value="half_yearly" <?= isset($type_data['package_type']) && html_escape($type_data['package_type'])=='half_yearly'?'selected':'';?>><?= !empty(lang('6_month'))?lang('6_month'):"6 Month";?></option>
