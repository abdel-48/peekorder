		...
		<form class="email_setting_form" action="<?= base_url('admin/settings/add_payment_settings') ?>" method="post" enctype= "multipart/form-data" autocomplete="off">
			...
			<?php if(active('paystack_status')==1): ?>
				<div class="card paystack">
					<div class="card-header mt-1">
						<h4><?= lang('paystack_payment_gateways');?></h4>
					</div>
					<div class="card-body">
						<div class="row">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="form-group">
									...
									<div class="">
										<textarea name="offline_details" id="offline_details" class="form-control" cols="5" rows="5" placeholder="<?= lang('');?></');?>"><?= !empty($offile->offline_details)?html_escape($offile->offline_details):'';  ?></textarea>
									</div>
									<div class="row mt-20">
										<div class="col-md-6">
