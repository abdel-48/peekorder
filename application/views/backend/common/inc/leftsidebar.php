				...
				<ul class="flex-column">
					...
					<?php if(is_access('profile-control')==1): ?>
						...
						<?php if(restaurant()->is_area_delivery==1): ?>
							<li><a href="<?= base_url('admin/restaurant/delivery_area/'.md5(restaurant()->id)); ?>" class="<?= isset($page_title) && $page_title == "Delivery Area"?"active":"" ;?>"><i class="icofont-fast-delivery"></i> <?= !empty(lang('delivery_area'))?lang('delivery_area'):"delivery area"; ?></a> </li>
						<?php endif;?>
