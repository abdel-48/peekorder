								...
								<div class="d_flex_alert-admin">
									...
									<div class="double_text">
										<div class="text-left">
											...
											<?php else: ?>
												<h5><label class="label bg-primary-soft"><?= order_type($order['order_type']);?> </label></h5>
											<?php endif ?>
							...
							<table class="table table-bordered table-condensed table-striped">
								...
								<?php foreach ($order['item_list'] as $key => $row): ?>
									...
									<?php 
										...
										$grand_total = grand_total($total_price,$order['delivery_charge'],$order['discount'],$order['tax_fee'],$order['coupon_percent'],$order['tips'],$order['order_type'],restaurant()->tax_status);
