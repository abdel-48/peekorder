				...
				<div class="col-md-8">
					<div class="card mt-50 payment_card sm-column-reverse">
						...
						<div class="card-body <?= is_package;?>">
							...
							<?php 
								$total_amount = grand_total($this->cart->total(),$payment['delivery_charge'],$payment['discount'],$payment['tax_fee'],$payment['coupon_percent'],$payment['tips'],$payment['order_type'],shop($payment['shop_id'])->tax_status);
							?>
