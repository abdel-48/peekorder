...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2022 at 02:13 PM
...
(948, 'sendgrid', 'admin', 'SendGrid', 'SendGrid', 'SendGrid', 'EnviarCuadrícula', 'Сетка отправки', 'SendGrid', 'EnvoyerGrille', 'EnviarGrid', 'सेंडग्रिड'),
(949, 'activities', 'admin', 'Activities', 'Activities', 'أنشطة', 'Actividades', 'Действия', '活動', 'Activités', 'Atividades', 'गतिविधियाँ'),
(950, 'mark_as_unread', 'admin', 'Mark as Unread', 'Mark as Unread', 'وضع علامة كغير مقروءة', 'Marcar como no leído', 'Отметить как непрочитанное', '標記為未讀', 'Marquer comme non lu', 'Marcar como não lido', 'अपठित के रूप में चिह्नित करें'),
(951, 'mark_as_read', 'admin', 'Mark as read', 'Mark as read', 'وضع علامة كمقروء', 'Marcar como leído', 'Отметить как прочитанное', '標記為已讀', 'Marquer comme lu', 'Marcar como lido', 'पढ़े के रूप में चिह्नित करें'),
...
(953, 'unseen_notification', 'admin', 'Unseen Notification', 'Unseen Notification', 'إعلام غير مرئي', 'Notificación no vista', 'Непросмотренное уведомление', '看不見的通知', 'Notification invisible', 'Notificação não vista', 'अनदेखी अधिसूचना');
INSERT INTO `language_data` (`id`, `keyword`, `type`, `details`, `english`, `ar`, `es`, `ru`, `cn`, `fr`, `pt`, `hindi`) VALUES
(954, 'seen_notification', 'admin', 'Seen Notification', 'Seen Notification', 'إشعار مرئي', 'Notificación vista', 'Уведомление о просмотре', '看到通知', 'Avis vu', 'Notificação vista', 'अधिसूचना देखी गई'),
(955, 'unseen', 'admin', 'Unseen', 'Unseen', 'غير مرئي', 'Invisible', 'Невидимый', '看不見', 'Invisible', 'Invisível', 'अनदेखा'),
(956, 'unseen_last_notification', 'admin', 'Unseen Last Notification', 'Unseen Last Notification', 'آخر إشعار غير مرئي', 'Última notificación no vista', 'Непросмотренное последнее уведомление', '看不見的最後通知', 'Dernière notification invisible', 'Última notificação não vista', 'अनदेखी अंतिम अधिसूचना'),
(957, 'send_notification', 'admin', 'Send Notification', 'Send Notification', 'إرسال إشعار', 'Enviar notificación', 'Отправить уведомление', '發送通知', 'Envoyer une notification', 'Enviar notificação', 'अधिसूचना भेजें'),
...
(965, 'checked_all', 'admin', 'Checked All', 'Checked All', 'تم تحديد الكل', 'Marcado todo', 'Все проверено', '檢查所有', 'Tous cochés', 'Verificou tudo', 'सभी की जांच की'),
(966, 'custom_fields', 'admin', 'Custom Fields', 'Custom Fields', 'الحقول المخصصة', 'Campos personalizados', 'Пользовательские поля', '自定義字段', 'Champs personnalisés', 'Campos personalizados', 'कस्टम फ़ील्ड'),
(967, 'demo', 'admin', 'Demo', 'Demo', 'عرض توضيحي', 'Demostración', 'Демо', '演示', 'Démo', 'Demonstração', 'डेमो'),
(968, 'restaurant_demo', 'admin', 'Restaurant Demo ', 'Demo Restaurant', 'مطعم تجريبي', 'Restaurante de demostración', 'Демонстрационный ресторан', '演示餐廳', 'Restaurant démo', 'Restaurante de demonstração', 'डेमो रेस्टोरेंट'),
(969, 'mark_as_delivered', 'admin', 'Mark as delivered', 'Mark as delivered', 'وضع علامة تم التسليم', 'Marcar como entregado', 'Отметить как доставленное', '标记为已送达', 'Marquer comme livré', 'Marcar como entregue', 'डिलीवर के रूप में चिह्नित करें'),
(970, 'delivered', 'admin', 'Delivered', 'Delivered', 'تم التسليم', 'Entregado', 'Доставлено', '已交付', 'Livré', 'Entregue', 'वितरित'),
(971, 'select_delivery_boy', 'admin', 'Select Delivery Boy', 'Select Delivery Boy', 'Select Delivery Boy', 'Seleccionar repartidor', 'Выберите курьера', '选择送货员', 'Sélectionner livreur', 'Selecionar entregador', 'डिलीवरी बॉय चुनें'),
(972, 'mark_as_paid', 'admin', 'Mark as Paid', 'Mark as Paid', 'وضع علامة كمدفوع', 'Marcar como pagado', 'Пометить как оплаченный', '标记为已付款', 'Marquer comme payé', 'Marcar como pago', 'भुगतान के रूप में चिह्नित करें'),
...
(975, 'completed_paid', 'admin', 'Completed & Paid', 'Completed & Paid', 'مكتمل ومدفوع', 'Completado y pagado', 'Выполнено и оплачено', '已完成并已支付', 'Terminé et payé', 'Concluído e pago', 'पूरा हुआ और भुगतान किया गया'),
(976, 'add_delivery_boy', 'admin', 'Add delivery Boy', 'Add delivery guy', 'إضافة مندوب توصيل', 'Añadir repartidor', 'Добавить курьера', '添加送货员', 'Ajouter un livreur', 'Adicionar entregador', 'डिलीवरी बॉय जोड़ें'),
(977, 'dboy_name', 'admin', 'Delivery Guy', 'Delivery Guy', 'مندوب التوصيل', 'Repartidor', 'Доставщик', '送货员', 'Livreur', 'Entrega', 'डिलीवरी गाई'),
...
(985, 'enable_whatsapp_for_order', 'admin', 'Enable WhatsApp For order', 'Enable WhatsApp For order', 'تمكين WhatsApp للطلب', 'Habilitar WhatsApp para pedidos', 'Включить WhatsApp для заказа', '为订单启用 WhatsApp', 'Activer WhatsApp pour la commande', 'Ativar WhatsApp para pedidos', 'व्हाट्सएप को ऑर्डर के लिए सक्षम करें'),
(986, 'room_services', 'admin', 'Room services', 'Room services', 'خدمات الغرف', 'Servicio de habitaciones', 'Обслуживание номеров', '客房服务', 'Service en chambre', 'Serviços de quarto', 'कक्ष सेवाएं'),
...
(989, 'room_numbers', 'admin', 'Room Numbers', 'Room Numbers', 'أرقام الغرف', 'Números de habitaciones', 'Номера комнат', '房间号', 'Numéros de chambre', 'Números dos quartos', 'कमरा नंबर'),
(990, 'sorry_room_numbers_not_available', 'admin', 'Sorry Room Not found', 'Sorry Room Not found', 'لم يتم العثور على غرفة معذرة', 'Lo siento, habitación no encontrada', 'Извините, номер не найден', '抱歉,找不到房间', 'Désolé, pièce introuvable', 'Desculpe, quarto não encontrado', 'सॉरी रूम नहीं मिला'),
(991, 'room_number', 'admin', 'Room Number', 'Room Number', 'رقم الغرفة', 'Número de habitación', 'Номер комнаты', '房间号', 'Numéro de chambre', 'Número do quarto', 'कमरा संख्या'),
(992, 'package_restaurant_dine_in', 'admin', 'Package / Restaurant Dine-In', 'Package / Restaurant Dine-In', 'حزمة / تناول الطعام في المطعم', 'Paquete / Cena en restaurante', 'Пакет / ресторан Dine-In', '套餐/餐厅堂食', 'Forfait / Dîner au restaurant', 'Pacote / Restaurante Restaurante', 'पैकेज / रेस्तरां डाइन-इन'),
(993, 'open_24_hours', 'admin', 'Open 24 Hours', 'Open 24 Hours', 'مفتوح 24 ساعة', 'Abierto 24 Horas', 'Открыто 24 часа', '24 小時營業', 'Ouvert 24h/24', 'Aberto 24 horas', '24 घंटे खुला'),
...
(995, 'select_room_number', 'admin', 'Select Room Number', 'Select Room Number', 'حدد رقم الغرفة', 'Seleccionar número de habitación', 'Выберите номер комнаты', '選擇房間號', 'Sélectionner le numéro de chambre', 'Selecione o número do quarto', 'कमरा नंबर चुनें');
